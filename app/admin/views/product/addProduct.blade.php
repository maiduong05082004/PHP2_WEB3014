            ...
            <div class="container-add">
                <div class="form-section-add">
                    ...
                    <div class="box-image">
                        ...
                        <img src="{{route(IMG_URL.'icon-food1.png')}}" id="update-image" class="update-product-image">
                    </div>
                    <div class="row mb10 " id="buttons">
                        ...
                        <a href="{{route('admin/product/list_product')}}"><input class="submit-btn" id="list" type="button" value="DANH SÁCH"></a>
                    </div>
                </div>
            </div>
        </form>
